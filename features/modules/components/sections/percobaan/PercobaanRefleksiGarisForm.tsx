  ...
  return (
    <section className="space-y-3 md:space-y-4">
      ...
      <div className="space-y-2">
        ...
        >
          <Select.Trigger className={`w-full border-2 shadow-[2px_2px_0_0_black] text-xs md:text-sm font-medium ${fieldColorClasses(fieldColors[`${refleksiItem.id}_selected`])}`} disabled={isChecked || isLocked}>
