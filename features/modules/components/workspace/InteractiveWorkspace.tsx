...
export function InteractiveWorkspace({ materialId }: { materialId?: string }) {
  ...
  return (
    <div className="border-4 border-black bg-white h-[300px] md:h-[600px] relative overflow-hidden shadow-lg flex flex-col">
      {materialId ? (
        ...
        <div className="w-full h-full flex flex-col items-center justify-center p-3 md:p-6 grow">
