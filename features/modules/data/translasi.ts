        ...
        items: [
          {
            ...
            explanation:
              "Titik awal (1, -2) bergeser ke (3, 1). Selisih koordinat memberikan nilai translasi (2, 3).",
          },
          {
            id: 2,
            type: "matriks",
            ...
            explanation:
              "Titik awal (-1, 4) bergeser ke (3, 1). Selisih koordinat memberikan nilai translasi (4, -3).",
          },
          {
            id: 3,
            type: "matriks",
            ...
            explanation:
              "Titik awal (6, 4) bergeser ke (3, 1). Selisih koordinat memberikan nilai translasi (-3, -3).",
          },
          {
            id: 4,
            type: "koordinat",
      ...
      percobaan: {
        ...
        items: [
          ...
          },
          {
            ...
            answer: "x - 2y = 6",
            acceptAnswers: ["y = x/2 - 3", "x = 2y + 6", "-2y + x = 6", "-y = -x/2 + 3", "-x = -2y - 6", "2y - x = -6", "-x + 2y = -6"],
