...
export default function ApersepsiLoading() {
  return (
    <div className="max-w-384 mx-auto px-4 md:px-12 py-6 md:py-8 space-y-4 md:space-y-6">
      ...
      <div className="relative border-4 border-black shadow-4 shadow-black p-6 md:p-8">
      ...
      <div className="border-4 border-black bg-white shadow-4 shadow-black p-6 md:p-8 space-y-4 md:space-y-6">
